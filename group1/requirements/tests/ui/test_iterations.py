...
class TestIterations(unittest.TestCase):
    ...
    def test_iterations(self):
        ...
        driver.find_element_by_xpath("//a[@onclick=\"showDialog('/req/newproject');\"]").click()
        for i in range(60):
            try:
                if self.is_element_present(By.ID, "id_title"): break
            except: pass
            time.sleep(1)
        else: self.fail("time out")
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("Selenium Test Iteration create, edit and delete")
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("Iteration Tests")
        ...
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("selenium create iteration test")
        ...
        time.sleep(1)
        driver.find_element_by_link_text("Selenium Test Iteration create, edit and delete").click()
        driver.find_element_by_link_text("Iterations").click()
        driver.find_element_by_link_text("New Iteration").click()
        for i in range(60):
            try:
        ...
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("This iteration says 2nd test iteration when it was created. All fields allowed will be changed to something with modified and date will change to something that already happened.")
        driver.find_element_by_xpath("//div[@id='id_start_date_popover']/div/span/i").click()
        for i in range(60):
            try:
                if self.is_element_present(By.XPATH, "//tr[5]/td[4]"): break
        ...
        driver.find_element_by_link_text("Project Detail").click()
        driver.find_element_by_link_text("Iterations").click()
        driver.find_element_by_xpath("//a[contains(@data-edit-iteration, '2nd test iteration')]").click()
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("MODIFIED:  This iteration says 2nd test iteration when it was created. All fields allowed will be changed to something with modified and date will change to something that already happened. THIS HAS BEEN MODIFIED")
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("2nd test iteration MODIFIED")
        driver.find_element_by_xpath("//div[@id='id_start_date_popover']/div/span/i").click()
        for i in range(60):
            try:
        ...
        time.sleep(1)
        driver.find_element_by_xpath("//a[contains(@data-del-iteration, '1st test iteration')]").click()
        for i in range(60):
            try:
                if self.is_element_present(By.LINK_TEXT, "Close"): break
            except: pass
            time.sleep(1)
        else: self.fail("time out")
        ...
        for i in range(60):
            try:
                if self.is_element_present(By.LINK_TEXT, "Delete Project"): break
            except: pass
            time.sleep(1)
        else: self.fail("time out")
