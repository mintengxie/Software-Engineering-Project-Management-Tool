...
class TestProjects(unittest.TestCase):
    ...
    def test_projects(self):
        ...
        driver.find_element_by_id("id_title").send_keys("1st Selenium Generated Project")
        for i in range(60):
            try:
                if self.is_element_present(By.ID, "id_description"): break
            except: pass
            time.sleep(1)
        else: self.fail("time out")
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("1st Generated Project by Selenium")
        ...
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("Another Selenium Generated Project")
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("Created Another Project via test")
        driver.find_element_by_link_text("Create Project").click()
        ...
        driver.find_element_by_id("id_title").clear()
        driver.find_element_by_id("id_title").send_keys("Selenium Generated Iteration 1")
        driver.find_element_by_id("id_description").clear()
        driver.find_element_by_id("id_description").send_keys("1st Iteration created by selenium")
        ...
        Select(driver.find_element_by_id("id_user_role")).select_by_visible_text("Developer")
        ...
        driver.find_element_by_id("password").send_keys("pass")
        driver.find_element_by_xpath("//button[@type='submit']").click()
        driver.find_element_by_xpath("//a[contains(@data-del-proj, 'Another Selenium Generated Project')]").click()
        time.sleep(1)
        driver.find_element_by_link_text("Close").click()
        time.sleep(1)
        driver.find_element_by_xpath("//a[contains(@data-del-proj, 'Another Selenium Generated Project')]").click()
        ...
        time.sleep(1)
        driver.find_element_by_xpath("//a[contains(@data-del-proj, '1st Selenium Generated Project')]").click()
        time.sleep(1)
        driver.find_element_by_link_text("Delete Project").click()
        time.sleep(1)
        driver.find_element_by_link_text("admin").click()
